...
@TraitName("secretshop_ender") //todo change this
public class Ender extends Trait { //todo change this
    public Ender() {
        super("secretshop_ender"); //todo change this
    }
    private Menu menu;
    ...
    public Menu getMenu() {
        ...
        if (this.menu == null)
            this.menu = new NPCMenu(displayname, "trades.ender"); //todo change this
        return this.menu;
    }
