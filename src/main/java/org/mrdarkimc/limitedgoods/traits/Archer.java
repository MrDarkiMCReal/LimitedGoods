...
@TraitName("secretshop_archer") //todo change this
public class Archer extends Trait { //todo change this
    public Archer() {
        super("secretshop_archer"); //todo change this
    }
    private Menu menu;
    ...
    public Menu getMenu() {
        ...
        if (this.menu == null)
            this.menu = new NPCMenu(displayname, "trades.archer"); //todo change this
        return this.menu;
    }
