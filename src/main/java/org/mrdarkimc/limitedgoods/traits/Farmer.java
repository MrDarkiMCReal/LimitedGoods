...
@TraitName("secretshop_farmer") //todo change this
public class Farmer extends Trait { //todo change this
    public Farmer() {
        super("secretshop_farmer"); //todo change this
    }
    private Menu menu;
    ...
    public Menu getMenu() {
        ...
        if (this.menu == null)
            this.menu = new NPCMenu(displayname, "trades.farmer"); //todo change this
        return this.menu;
    }
