...
@TraitName("secretshop_armory") //todo change this
public class Armory extends Trait { //todo change this
    public Armory() {
        super("secretshop_armory"); //todo change this
    }
    private Menu menu;
    ...
    public Menu getMenu() {
        ...
        if (this.menu == null)
            this.menu = new NPCMenu(displayname, "trades.armory"); //todo change this
        return this.menu;
    }
